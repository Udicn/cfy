...
void EXTI9_5_IRQHandler(void)
{
		...
		HAL_GPIO_EXTI_IRQHandler(GPIO_PIN_9);        /* 调用中断处理公用函数 清除PA8所在中断线的中断标志位*/
		HAL_GPIO_EXTI_IRQHandler(GPIO_PIN_7);        /* 调用中断处理公用函数 清除PA8所在中断线的中断标志位*/
}

void EXTI15_10_IRQHandler(void)
{
			HAL_GPIO_EXTI_IRQHandler(GPIO_PIN_10);        /* 调用中断处理公用函数 清除PA8所在中断线的中断标志位*/
}
/* USER CODE END 2 */
